...
<img src="img/thirdOne.jpg" class="mainPic" alt="seelenPfad">
...
<div class="wrapper two">
    <main>
        <h3>Seelenpfad</h3>
        <p>
            «Sendalva» kommt vom Romanischen und beinhaltet die beiden Wörter «senda» und «alva». Die Bedeutung lässt
            sich mit «weisser Pfad» umschreiben. Manchmal begegnen wir Fragestellungen im Leben, die uns tiefer berühren
            und uns nicht so schnell loslassen. Die Beantwortung dieser Fragen führt uns gleichzeitig auf unserem Seelenpfad voran.
            ...
            <br>
            <br>
            <span class="adresse zitat">«Der Kern des Glücks: <br>Der sein zu wollen, der du bist.»<br><br>
        <i>Erasmus von Rotterdam </i></span>
        </p>
    </main>
    <aside>
